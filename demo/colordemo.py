...
class Myframe(wx.Frame):
    ...
    def create_Toolbar(self):
        ...
        add = toolbar.AddSimpleTool(wx.NewId(), wx.Bitmap("../img/save24.png"), "New", "long help for 'New'")
        edit = toolbar.AddSimpleTool(wx.NewId(), wx.Bitmap("../img/save24.png"), "Edit", "long help for 'Edit'")
        toolbar.Realize()
